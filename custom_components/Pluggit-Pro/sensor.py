...
from .device_map import SENSORS, PluggitSensorEntityDescription
...
async def async_setup_entry(hass: HomeAssistant, config_entry, async_add_entities):
    ...
    for description in SENSORS:
        if await device.async_install_entity(description):
            sensor = PluggitSensor(device, description)
...
class PluggitSensor(SensorEntity, PluggitEntity):
    """Pluggit sensor."""
    ...
    def __init__(
        ...
        self.entity_description: PluggitSensorEntityDescription = description
