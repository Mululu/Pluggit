...
from .device_map import COVERS, PluggitCoverEntityDescription
...
async def async_setup_entry(hass: HomeAssistant, config_entry, async_add_entities):
    ...
    for description in COVERS:
        if await device.async_install_entity(description):
            cover = PluggitCover(device, description)
...
class PluggitCover(CoverEntity, PluggitEntity):
    """Pluggit cover."""

    def __init__(
        self,
        device: Device,
        description: PluggitCoverEntityDescription,
    ) -> None:
        """Init cover."""
        super().__init__(device)
        self._device = device
        self._attr_has_entity_name = True
        self.entity_description: PluggitCoverEntityDescription = description
