...
class CurrentUnitMode(int):
    """Pluggit current unit mode class."""
...
class ActiveUnitMode(int):
    """Pluggit active unit mode class."""
...
class BypassDamperState(int):
    """Pluggit bypass damper state class."""
...
class PluggitButtonEntityDescription(ButtonEntityDescription):
    """Pluggit Button Entity Description."""
...
@dataclass
class PluggitCoverEntityDescription(CoverEntityDescription):
    """Pluggit Cover Entity Description."""
...
class PluggitNumberEntityDescription(NumberEntityDescription):
    """Pluggit Number Entity Description."""
...
@dataclass
class PluggitSelectEntityDescription(SelectEntityDescription):
    """Pluggit Select Entity Description."""
...
class PluggitSensorEntityDescription(SensorEntityDescription):
    """Pluggit Sensor Entity Description."""
...
class PluggitSwitchEntityDescription(SwitchEntityDescription):
    """Pluggit Switch Entity Description."""
...
COVERS: tuple[PluggitCoverEntityDescription, ...] = (
    PluggitCoverEntityDescription(
        key="bypass_damper",
...
SELECTS: tuple[PluggitSelectEntityDescription, ...] = (
    PluggitSelectEntityDescription(
