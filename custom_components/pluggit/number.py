...
from .device_map import NUMBERS, PluggitNumberEntityDescription
...
async def async_setup_entry(hass: HomeAssistant, config_entry, async_add_entities):
    ...
    for description in NUMBERS:
        if await device.async_install_entity(description):
            cover = PluggitNumber(device, description)
...
class PluggitNumber(NumberEntity, PluggitEntity):
    """Pluggit number."""
    ...
    def __init__(
        ...
        self.entity_description: PluggitNumberEntityDescription = description
