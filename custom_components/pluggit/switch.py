...
from .device_map import SWITCHES, PluggitSwitchEntityDescription
...
async def async_setup_entry(hass: HomeAssistant, config_entry, async_add_entities):
    ...
    for description in SWITCHES:
        if await device.async_install_entity(description):
            switch = PluggitSwitch(device, description)
...
class PluggitSwitch(SwitchEntity, PluggitEntity):
    """Pluggit switch."""
    ...
    def __init__(
        ...
        self.entity_description: PluggitSwitchEntityDescription = description
